...
public class EmployeeService {
    ...
    public Page<EmployeeListDto> getEmployees(EmployeeRequest.List request, Pageable pageable) {
        Page<Employee> employees = employeeRepository.getEmployeesSearch(request, pageable);
        ...
        return employees.map(e -> EmployeeListDto.of(e, employeeDepartmentMap.getOrDefault(e.getIdx(), emptyList())));
    }
